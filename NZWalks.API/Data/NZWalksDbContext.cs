    ...
    public class NZWalksDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var difficulties = new List<Difficulty>()
            {
                new Difficulty
                {
                    DifficultyId = Guid.Parse("8ea72cd0-6ded-424c-9e74-fe1e18186d14"),
                    Name = "Easy",
                },
                new Difficulty
                {
                    DifficultyId = Guid.Parse("791b2dd9-420d-4776-b580-aef2de99c693"),
                    Name = "Medium",
                },
                new Difficulty
                {
                    DifficultyId = Guid.Parse("ba3862a4-3a79-4715-abea-2be20a81fa37"),
                    Name = "Hard",
                }
            };
