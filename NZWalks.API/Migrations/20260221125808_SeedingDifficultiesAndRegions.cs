    ...
    public partial class SeedingDifficultiesAndRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("791b2dd9-420d-4776-b580-aef2de99c693"), "Medium" },
                    { new Guid("8ea72cd0-6ded-424c-9e74-fe1e18186d14"), "Easy" },
                    { new Guid("ba3862a4-3a79-4715-abea-2be20a81fa37"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                ...
                keyValue: new Guid("791b2dd9-420d-4776-b580-aef2de99c693"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "DifficultyId",
                keyValue: new Guid("8ea72cd0-6ded-424c-9e74-fe1e18186d14"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "DifficultyId",
                keyValue: new Guid("ba3862a4-3a79-4715-abea-2be20a81fa37"));
